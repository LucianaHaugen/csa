package com.sigmatechnology.csa.config.metrics;
...
public class SpectatorLogMetricWriter implements MetricWriter {
    ...
    public void set(Metric<?> metric) {
        ...
        log.info("type=GAUGE, hystrix_type={}, com.sigmatechnology.csa.service={}, method={}, name={}, value={}", hystrixType, serviceName, methodName, metricName, metric.getValue());
    }
